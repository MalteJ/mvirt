...
impl From<&NicData> for Nic {
    fn from(data: &NicData) -> Self {
        Self {
            ...
            network_id: data.spec.network_id.clone(),
            mac_address: data.spec.mac_address.clone(),
            ipv4_address: data.spec.ipv4_address.clone(),
            ipv6_address: data.spec.ipv6_address.clone(),
            routed_ipv4_prefixes: data.spec.routed_ipv4_prefixes.clone(),
            routed_ipv6_prefixes: data.spec.routed_ipv6_prefixes.clone(),
            socket_path: data.status.socket_path.clone(),
