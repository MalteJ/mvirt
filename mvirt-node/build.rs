fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    tonic_prost_build::configure()
        ...
        .extern_path(
            ".mvirt.DiskConfig",
            "::mvirt_daemon_protos::vmm::DiskConfig",
        )
        .extern_path(".mvirt.NicConfig", "::mvirt_daemon_protos::vmm::NicConfig")
        .extern_path(".mvirt.zfs.Volume", "::mvirt_daemon_protos::zfs::Volume")
        .extern_path(
            ".mvirt.zfs.Snapshot",
            "::mvirt_daemon_protos::zfs::Snapshot",
        )
        .extern_path(
            ".mvirt.zfs.Template",
            "::mvirt_daemon_protos::zfs::Template",
        )
        .extern_path(
            ".mvirt.zfs.ImportJob",
            "::mvirt_daemon_protos::zfs::ImportJob",
        )
        .extern_path(
            ".mvirt.zfs.ImportJobState",
            "::mvirt_daemon_protos::zfs::ImportJobState",
        )
        .extern_path(".mvirt.net.Nic", "::mvirt_daemon_protos::net::Nic")
        .extern_path(
            ".mvirt.net.NicState",
            "::mvirt_daemon_protos::net::NicState",
        )
